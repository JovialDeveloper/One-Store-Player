...
extension FixturesScoresView{
    class FixturesScoresViewModel:ObservableObject{
        ...
        func fetchData(){
            ...
            var request = URLRequest(url: URL(string: "https://api.1store.ae/users/8c094a6b-597b-4564-8bd7-e1a541805def/fixtures?time=2022-09-14&time_zone=Africa/Casablanca")!,timeoutInterval: Double.infinity)
