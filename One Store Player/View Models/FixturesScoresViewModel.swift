...
extension FixturesScoresView{
    class FixturesScoresViewModel:ObservableObject{
        ...
        func fetchData(){
            ...
            var request = URLRequest(url: URL(string: "https://api.1store.ae/users/8c094a6b-597b-4564-8bd7-e1a541805def/fixtures?time=04-12-2022&time_zone=Asia/Qatar")!,timeoutInterval: Double.infinity)
